...
//        SendBird.notifyActivityPausedForOldAndroids();
    ...
    private void initFragment() {
       ...
       // ((TextView) findViewById(R.id.txt_channel_name)).setText(mChannelUrl);
    ...
    public static class SendBirdChatFragment extends Fragment {
        ...
        private void updateGroupChannelTitle() {
            ...
            if(mGroupChannel.getMembers()!=null || mGroupChannel.getMembers().size()!=0 ){
                ((TextView) getActivity().findViewById(R.id.txt_channel_name)).
                    setText(Helper.getDisplayMemberNames(mGroupChannel.getMembers(), true));
                ((TextView) getActivity().findViewById(R.id.txt_channel_name)).setTypeface(roboto);
            }
        }
    ...
    public static class SendBirdMessagingAdapter extends BaseAdapter {
        ...
        private static long leftFlag, rightFlag;
        ...
        public SendBirdMessagingAdapter(Context context, GroupChannel channel) {
            ...
            Log.d("leftFlag","init-leftFlag="+leftFlag);
            Log.d("rightFlag","init-rightFlag="+rightFlag);
            ...
            switch (getItemViewType(position)) {
                ...
                case TYPE_USER_MESSAGE:
                    ...
                    if (message.getSender().getUserId().equals(SendBird.getCurrentUser().getUserId())) {
                        ...
                        viewHolder.getView("right_name", TextView.class).setText(message.getSender().getUserId());
                        viewHolder.getView("right_name", TextView.class).setTypeface(roboto);

                        viewHolder.getView("right_message", TextView.class).setMovementMethod(LinkMovementMethod.getInstance());

                        viewHolder.getView("right_message", TextView.class).setText(message.getMessage());
                        viewHolder.getView("right_message", TextView.class).setTypeface(roboto);

                        if(rightFlag == 0) {
                            rightFlag = message.getCreatedAt();
                            viewHolder.getView("right_time", TextView.class).setVisibility(View.VISIBLE);
                        }else {
                            if (message.getCreatedAt() - leftFlag > 72000000l
                                   /* ||
                                    message.getCreatedAt() - leftFlag < 72000000*/) {
                                viewHolder.getView("right_time", TextView.class).setVisibility(View.VISIBLE);
                                rightFlag = message.getCreatedAt();
                            }
                            /*else {
                                if (viewHolder.getView("left_time", TextView.class).getVisibility() == View.VISIBLE)
                                    ;
                                else
                                    viewHolder.getView("left_time", TextView.class).setVisibility(View.GONE);
                            }
                            */
                        }
                      ...
                      /* if(rightFlag == 0) {
                           ...
                           if (message.getCreatedAt() - rightFlag > 72000000l) {
                               viewHolder.getView("right_time", TextView.class).setVisibility(View.VISIBLE);
                               rightFlag = message.getCreatedAt();
                           } else
                               viewHolder.getView("right_time", TextView.class).setVisibility(View.GONE);
                       }*/
                        viewHolder.getView("right_time", TextView.class).setText(Helper.getDisplayDateTime(mContext, message.getCreatedAt()));
                        viewHolder.getView("right_time", TextView.class).setTypeface(roboto);


                       /* Log.d("leftFlag","init-leftFlag="+leftFlag);
                        Log.d("rightFlag","init-rightFlag="+rightFlag);
                        Log.d("right_time",Helper.getDisplayDateTime(mContext, message.getCreatedAt()));*/


                        int unreadCount = mGroupChannel.getReadReceipt(message);
                        if (unreadCount > 1) {
                            viewHolder.getView("right_status", TextView.class).setBackgroundResource(R.drawable.status_deliverd);
                            viewHolder.getView("right_status", TextView.class).setTypeface(roboto);
                            ...
                            viewHolder.getView("right_status", TextView.class).setBackgroundResource(R.drawable.status_read);
                            viewHolder.getView("right_status", TextView.class).setTypeface(roboto);
                        ...
                        viewHolder.getView("left_name", TextView.class).setText(message.getSender().getUserId());
                        viewHolder.getView("left_name", TextView.class).setTypeface(roboto);

                        viewHolder.getView("left_message", TextView.class).setMovementMethod(LinkMovementMethod.getInstance());

                        viewHolder.getView("left_message", TextView.class).setText(message.getMessage());
                        viewHolder.getView("left_message", TextView.class).setTypeface(roboto);

                        //TODO created time limit

                        if(leftFlag == 0) {
                            leftFlag = message.getCreatedAt();
                            viewHolder.getView("left_time", TextView.class).setVisibility(View.VISIBLE);
                        }else {
                            if (message.getCreatedAt() - leftFlag > 72000000l
                                   /* ||
                                    message.getCreatedAt() - leftFlag < 72000000*/) {
                        ...
                        Log.d("leftFlag","leftFlag="+leftFlag);
                       // Log.d("rightFlag","init-rightFlag="+rightFlag);
                        Log.d("left_time",Helper.getDisplayDateTime(mContext, message.getCreatedAt()));

                        viewHolder.getView("left_time", TextView.class).setText(Helper.getDisplayDateTime(mContext, message.getCreatedAt()));
                        viewHolder.getView("left_time", TextView.class).setTypeface(roboto);
                ...
                case TYPE_ADMIN_MESSAGE:
                    ...
                    viewHolder.getView("message", TextView.class).setTypeface(roboto);
                ...
                case TYPE_FILE_MESSAGE:
                    ...
                    if (fileLink.getSender().getUserId().equals(SendBird.getCurrentUser().getUserId())) {
                        ...
                        viewHolder.getView("right_name", TextView.class).setText(fileLink.getSender().getUserId());
                        viewHolder.getView("right_name", TextView.class).setTypeface(roboto);
                        ...
                        viewHolder.getView("left_name", TextView.class).setText(fileLink.getSender().getUserId());
                        viewHolder.getView("left_name", TextView.class).setTypeface(roboto);
